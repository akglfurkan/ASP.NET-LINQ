...
namespace EntityFrameworkSamples
{
    public class DataInitializer : DropCreateDatabaseIfModelChanges<UrunContext>
    {
        ...
        protected override void Seed(UrunContext context)
        {
            ...
            {
                    new Urun(){ UrunAdi="aSamsung S5", Fiyat=1000, StokAdeti=100, KategoriId=1},
                    new Urun(){ UrunAdi="bSamsung S6", Fiyat=2000, StokAdeti=100, KategoriId=1},
                    new Urun(){ UrunAdi="cSamsung S7", Fiyat=3000, StokAdeti=100, KategoriId=1},
                    new Urun(){ UrunAdi="dSamsung S8", Fiyat=4000, StokAdeti=20, KategoriId=1},
                    new Urun(){ UrunAdi="Samsung S9", Fiyat=5000, StokAdeti=100, KategoriId=1},
                    new Urun(){ UrunAdi="hSamsung S00", Fiyat=6000, StokAdeti=0, KategoriId=1},
                    ...
                    new Urun(){ UrunAdi="dBilgisayar ürünü 2 ", Fiyat=2000, StokAdeti=100, KategoriId=2},
                    ...
                    new Urun(){ UrunAdi="sBilgisayar ürünü 5", Fiyat=5000, StokAdeti=100, KategoriId=2},
                    new Urun(){ UrunAdi="aBilgisayar ürünü 5", Fiyat=6000, StokAdeti=0, KategoriId=2},
                    new Urun(){ UrunAdi="aaBilgisayar ürünü 7", Fiyat=7000, StokAdeti=100, KategoriId=2},
